...
// Fetch provides a mock function with given fields: ctx, cMetadata
func (_m *MockFetcher) Fetch(ctx context.Context, cMetadata fetching.CycleMetadata) error {
	ret := _m.Called(ctx, cMetadata)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, fetching.CycleMetadata) error); ok {
		r0 = rf(ctx, cMetadata)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - cMetadata fetching.CycleMetadata
func (_e *MockFetcher_Expecter) Fetch(ctx interface{}, cMetadata interface{}) *MockFetcher_Fetch_Call {
	return &MockFetcher_Fetch_Call{Call: _e.mock.On("Fetch", ctx, cMetadata)}
}

func (_c *MockFetcher_Fetch_Call) Run(run func(ctx context.Context, cMetadata fetching.CycleMetadata)) *MockFetcher_Fetch_Call {
